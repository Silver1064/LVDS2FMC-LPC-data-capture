...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xpm -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot ILA xil_defaultlib.ILA xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ILA -key {Behavioral:sim_1:Functional:ILA} -tclbatch cmd.tcl -protoinst "protoinst_files/ILA.protoinst" -log simulate.log
}
