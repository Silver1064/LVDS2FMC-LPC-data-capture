...
HD_PWD='C:/My Xillinx/Vivado/afe7225/project_adc_capture/project_adc_capture.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_ADC_DATA_CAPTURING.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_ADC_DATA_CAPTURING.tcl
