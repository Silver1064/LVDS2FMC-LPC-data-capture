...
HD_PWD='C:/My Xillinx/Vivado/afe7225/project_adc_capture/project_adc_capture.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_ADC_DATA_CAPTURING.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_ADC_DATA_CAPTURING.tcl -notrace
